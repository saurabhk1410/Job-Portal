...
const SkillsForm = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto mt-10 p-6 border-2 rounded-2xl ">
      <h2 className="text-2xl font-bold text-center mb-6">Skill Tracker</h2>
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between mb-6">
        <div className="flex items-center gap-8 w-full">
          <input
            ...
            className="input input-bordered w-full sm:max-w-xs focus:outline-0"
          />

          <div className="tooltip tooltip-top" data-tip="Rate your skill level">
